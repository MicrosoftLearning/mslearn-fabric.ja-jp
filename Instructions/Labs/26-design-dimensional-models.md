...
> **ヒント:** 関連するトレーニング コンテンツについては、「[Microsoft Fabric で分析用のディメンション モデルを設計する](https://learn.microsoft.com/training/modules/design-dimensional-models-fabric/)」を参照してください。
...
3. [詳細]__ セクションで **[Fabric と Power BI ワークスペースの種類]** を選択します。 選択肢は [Fabric]、[Fabric 試用版]、[Power BI Premium]__ などとなります。
