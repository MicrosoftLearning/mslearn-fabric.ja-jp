...
1. ブラウザーで Microsoft Fabric ホーム ページ `https://app.fabric.microsoft.com` に移動します。
...
1. ノートブックで、最新のセルの下にある **[+ コード]** アイコンを使用して、新しいコード セルをノートブックに追加します。 次のコードを入力して、データを読み込んで準備し、それを使用してモデルをトレーニングします。
...
1. ノートブック エディターの左側の **[レイクハウス]** ペインで、**[追加]** を選択してレイクハウスを追加します。
