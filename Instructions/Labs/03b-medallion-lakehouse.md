...
1. [Microsoft Fabric ホーム ページ](https://app.fabric.microsoft.com/home?experience=fabric) (`https://app.fabric.microsoft.com/home?experience=fabric`) で、**[Power BI]** を選択します。
...
レイクハウスの作成時に自動的に作成される**既定のセマンティック モデル**は使用できないことに注意してください。 レイクハウス エクスプローラーから、この演習で作成したゴールド テーブルを含む新しいセマンティック モデルを作成する必要があります。

1. ワークスペースで、**Sales** レイクハウスに移動します。
2. レイクハウス エクスプローラー ビューのリボンから **[新しいセマンティック モデル]** を選びます。
3. 名前 **Sales_Gold** を新しいセマンティック モデルに割り当てます。
4. セマンティック モデルに含める変換済のゴールド テーブルを選び、**[確認]** を選びます。
   - dimdate_gold
   - dimcustomer_gold
   - dimproduct_gold
   - factsales_gold

    すると、リレーションシップとメジャーを作成できるセマンティック モデルが Fabric で開きます。
