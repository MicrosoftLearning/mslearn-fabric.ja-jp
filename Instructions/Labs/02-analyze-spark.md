...
* [Microsoft Fabric 試用版](/fabric/get-started/fabric-trial#start-the-fabric-capacity-trial)
...
ワークスペースが作成されたので、レイクハウスを作成してデータ ファイルを保存できます。 新しいワークスペースから **[新規]** と **[レイクハウス]** を選択します。 レイクハウスに名前を付け、**[作成]** を選択します。 しばらくすると、新しいレイクハウスが作成されます。
...
1. ワークスペースを選択し、**[新規]** と **[ノートブック]** を選択します。 数秒後に、1 つの ''セル'' を含む新しいノートブックが開きます。 ノートブックは、''コード'' または ''マークダウン'' (書式設定されたテキスト) を含むことができる 1 つ以上のセルで構成されます。
...
4.   2019.csv の [...] メニューで、**[データの読み込み]**、**[Spark]** の順に選択します。 次のコードは、新しいコード セルに自動的に生成されます。
...
1. 現在のセルまたはその出力の上または下にマウス ポインターを置くと表示される **[+ コード]** を選択して、コード セルを追加します。 または、リボン メニューで **[編集]**、**[+ コード セルの追加]** を選択します。
...
4.   salesorders テーブルのメニューで、**[データの読み込み]** > 、**[Spark]** の順に選択します。 新しいコード セルが次のようなコードが入って追加されます。
