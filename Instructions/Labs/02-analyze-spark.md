...
1. レイクハウスに任意の一意の名前を付けて、*[レイクハウス スキーマ (パブリック プレビュー)]* オプションを**オフ**にします。

    > **重要**: *[レイクハウス スキーマ]* オプションの設定は、レイクハウスを作成した後では変更できないため、**オフ**になっていることを確認してください。 このステップを実行しない場合、新しいレイクハウスの作成が必要になります。
