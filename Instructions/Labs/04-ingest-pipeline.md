...
1. ご自分のレイクハウスの **[ホーム]** ページで、**[データの取得]**、**[新しいコピー ジョブ]** の順に選択し、`Ingest Sales Data` という名前の新しいデータ パイプラインを作成します。
1. **コピー ジョブ** ウィザードが自動的に開かない場合は、パイプライン エディター ページで **[任意のソースから任意の宛先へ]** を選択します。
1. **[コピー ジョブ]** ウィザードの **[データ ソースの選択]** ページで、検索バーに「HTTP」と入力し、**[新しいソース]** セクションで **[HTTP]** を選択します。
