...
> **ヒント:** 関連するトレーニング コンテンツについては、「[OneLake でデータを検出して接続する](https://learn.microsoft.com/training/modules/discover-data-onelake/)」を参照してください。
...
1. _[詳細]_ セクションで **[Fabric と Power BI ワークスペースの種類]** を選択します。 選択肢は [Fabric]、[Fabric 試用版]、[Power BI Premium]__ などとなります。
...
1. ワークスペースで **[+ 新しい項目]** を選択し、次に **[レイクハウス]** を選択します。 お好みの名前を付けます (例: _salesdata_)。
...
1. 左側のナビゲーション ウィンドウで **[OneLake カタログ]** を選択します。 カタログで **[探す]** タブを選択し、**[データ項目]** でまだ選択されていなければフィルターします。

    ![さまざまなデータ資産が一覧表示された OneLake カタログを示すスクリーンショット。](./Images/onelake-catalog-explore.png)

1. カタログには、レイクハウス、ウェアハウス、セマンティック モデル、レポートなど、さまざまな項目の種類が表示されます。 リストを閲覧して、**[salesdata]** レイクハウス (または任意の名前) を探します。
...
1. カタログから、**[salesdata]** レイクハウスを選択して開きます。
...
1. ワークスペースのリストで、元の **[salesdata]** レイクハウスを含むワークスペース (たとえば、_[Data-Engineering]_) を選択します。

1. **[salesdata]** レイクハウスを選択し、**[Tables]** フォルダーを選択します。
