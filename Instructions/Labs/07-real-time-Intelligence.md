...
1. **Microsoft Fabric** エクスペリエンス ポータルで、次に示すように**リアルタイム インテリジェンス** エクスペリエンス イメージを選択します。

    ![リアルタイム インテリジェンスが選択されている、選択された Fabric Experience ホームのスクリーンショット](./Images/fabric-experience-home.png)

2. **リアルタイム インテリジェンス** エクスペリエンスの **[ホーム]** ページで、**[KQL データベース]** を選択し、任意の名前の新しいデータベースを作成します。
