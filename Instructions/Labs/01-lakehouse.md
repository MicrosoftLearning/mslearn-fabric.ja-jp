...
1. ツール バーの **[モデル レイアウト]** を選択します。 セマンティック モデルのデータ モデル スキーマが表示されます。

    ![モデル レイアウトのスクリーンショット](./Images/lakehouse-model-layouts.png)
...
5. **[ファイル]** メニューの **[保存]** をクリックします。 次に、前に作成したワークスペースにレポートを `Item Sales Report` として保存してください。
